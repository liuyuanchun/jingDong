...
$().ready(function(e) {
	...
	//图书详情
   $(".showDetial").click(function(){
	   window.location.href="showBook?proId="+$(this).data("proid");
   });
	//图书分类列表
   $(".showList").click(function(){
	   window.location.href="list?sId="+$(this).data("sid");
   });
...
<style type="text/css">
  ...
  <div id="d2" style="cursor:pointer" class="showList" data-sid="14"> </div>
  <div id="d3">
...
<div id="d7">
	<div id="d71">
    	<div class="d711">
        	<ul id="u5">
            	<li style="cursor:pointer" class="showList" data-sid="20">曹文轩</li>
                <li class="showDetial" style="cursor:pointer" data-proid="30">DK</li>
                <li class="showDetial" style="cursor:pointer" data-proid="35">超级战舰</li>
                <li style="cursor:pointer" class="showList" data-sid="15">迪士尼</li>
                <li style="cursor:pointer" class="showList" data-sid="13">凯迪克</li>
                <li style="cursor:pointer" class="showList" data-sid="11">辅食</li>
            </ul>
        </div>
        <div class="d712">
        	<ul id="u6">
            	<li style="margin-top:0px;background-color:#9F7ADD"></li>
        		<li style="cursor:pointer" class="showList" data-sid="11">热门读物</li>
            	<li style="cursor:pointer" class="showList" data-sid="13">0-2岁</li>
            	<li style="cursor:pointer" class="showList" data-sid="14">3-6岁</li>
            	<li style="cursor:pointer" class="showList" data-sid="15">7-10岁</li>
            	<li style="cursor:pointer" class="showList" data-sid="16">11-14岁</li>
            	<li style="cursor:pointer" class="showList" data-sid="20">家教育儿</li>
        	</ul>
        </div>
        <div class="d713"></div>
	</div>
    <div id="d72">
    	<div class="d721 showDetial" style="cursor:pointer" data-proid="33"></div>
        <div class="d722 showDetial" style="cursor:pointer" data-proid="34"></div>
        <div class="d723 showDetial" style="cursor:pointer" data-proid="35"></div>
	</div>
    <div id="d73">
    	<ul id="u7">
        	<li class="showDetial" style="cursor:pointer" data-proid="27">
            ...
            <li class="showDetial" style="cursor:pointer" data-proid="28">
            ...
            <li class="showDetial" style="cursor:pointer" data-proid="29">
            ...
            <li class="showDetial" style="cursor:pointer" data-proid="30">
            ...
            <li class="showDetial" style="cursor:pointer" data-proid="31">
            ...
            <li class="showDetial" style="cursor:pointer" data-proid="32">
