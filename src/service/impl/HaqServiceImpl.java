...
public class HaqServiceImpl implements HaqService{
	...
	public boolean doSupplierModify(Supplier supplier) {
		boolean flag =false;
		int res  = haqDao.doSupplierModify(supplier);
		if(res>0){
			flag = true;
		}
		return flag;
	...
	public boolean deleteSupplierById(Supplier supplier) {
		boolean flag =false;
		int res  = haqDao.deleteSupplierById(supplier);
		if(res>0){
			flag = true;
		}
		return flag;
	...
	public boolean addSupplier(Supplier supplier) {
		boolean flag =false;
		int res  = haqDao.addSupplier(supplier);
		if(res>0){
			flag = true;
		}
		return flag;
	...
	public List<SupplierOrder> getListForSupplierOrder(
			SupplierOrder supplierOrder) {
		return haqDao.getListForSupplierOrder(supplierOrder);
	}

	public SupplierOrder getDTOFotSupplierOrder(SupplierOrder supplierOrder) {
		return haqDao.getDTOFotSupplierOrder(supplierOrder);
	}

	public boolean doSupplierOrderModify(SupplierOrder supplierOrder) {
		boolean flag =false;
		int res  = haqDao.doSupplierOrderModify(supplierOrder);
		if(res>0){
			flag = true;
		}
		return flag;
	...
	public boolean deleteSupplierOrderById(SupplierOrder supplierOrder) {
		boolean flag =false;
		int res  = haqDao.deleteSupplierOrderById(supplierOrder);
		if(res>0){
			flag = true;
		}
		return flag;
	...
	public List<Pro> getListForPro() {
		return haqDao.getListForPro();
	}

	public boolean addSupplierOrder(SupplierOrder supplierOrder) {
		boolean flag =false;
		int res  = haqDao.addSupplierOrder(supplierOrder);
		if(res>0){
			flag = true;
		}
		return flag;
